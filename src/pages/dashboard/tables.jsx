      ...
      <Card>
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <table className="w-full min-w-[640px] table-auto">
            <thead>
              <tr>
                {["Usuario", "Rol", "Estado", "Fecha de ingreso", "Opciones"].map((el) => (
                  <th
                    key={el}
                    ...
                    <tr key={name}>
                      <td className={className}>
                        <div className="flex items-start gap-4">
                          <Avatar src={img} alt={name} size="md" variant="rounded" />
                      ...
                      <td className={className} style={{display:'flex', flexDirection:'row', }}>
                        <Button>
                          Editar
                        </Button>
                        <Button>
