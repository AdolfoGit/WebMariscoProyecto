              ...
              <div className="container mx-auto  lg:px-0 pt-4 lg:pt-20 ">
                <div className="flex flex-col md:flex-row justify-between md:items-start text-left p-0 lg:p-5">
                  ...
                  <div className="flex flex-col w-full md:w-1/4 gap-4">
                    <Typography className="text-2xl font-bold text-gray-100">Contactanos</Typography>
                    <span className="border-b-2 border-gray-400 w-28 h-2 "></span>
                    <Typography className="text-md text-gray-400 font-medium">LaCasaDelMarisco@gmail.com</Typography>
                    <Typography className="text-md text-gray-400 font-medium">Telefono: +527898963578</Typography>
                    <Typography className="text-md text-gray-400 font-medium">Mision / Vision</Typography>
                    <Typography className="text-md text-gray-400 font-medium">Politicas de Cookies</Typography>
                  </div>

                  <div className="flex flex-col w-full md:w-1/4 gap-4">
                    <Typography className="text-2xl font-bold text-gray-100">Horas de Trabajo</Typography>
                    <span className="border-b-2 border-gray-400 w-28 h-2"></span>
                    <Typography className="text-md text-gray-400 font-bold">Lunes - Sabado:</Typography>
                    <Typography className="text-md text-gray-400 font-medium">9:00am - 21:00pm</Typography>
                    <Typography className="text-md text-gray-400 font-bold">Domingo:</Typography>
                    <Typography className="text-md text-gray-400 font-medium">9:00am - 22:00pm</Typography>
                  </div>

                  <div className="flex flex-col w-full md:w-1/4 gap-4">
                    <Typography className="text-2xl font-bold text-gray-100">Siguenos en Redes</Typography>
